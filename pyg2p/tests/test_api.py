...
class TestAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        pyg2p.util.files.delete_file(os.path.join(self.conf.geopotentials.data_path, 'T3999.gph.grb'))
    ...
    def test_add_geopotential(self):
        ...
        self.assertTrue(not pyg2p.util.files.exists(os.path.join(self.conf.geopotentials.data_path, 'T3999.gph.grb')))
        ...
        self.assertTrue(pyg2p.util.files.exists(os.path.join(self.conf.geopotentials.data_path, 'T3999.gph.grb')))
